...
@Entity
public class HARIHARANMedicine {
     ...
     public HARIHARANMedicine() {

     }

     public HARIHARANMedicine(int medicineId, String medicineName, String medicineFor, String medicineBrand,
