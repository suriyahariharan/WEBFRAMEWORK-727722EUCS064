...
public class HARIHARANCourse {
     ...
     public HARIHARANCourse() {

     }

     public HARIHARANCourse(int courseId, String courseName, int creditHours, String instructor, String preRequistes,
